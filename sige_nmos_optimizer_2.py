...
def main():
    ...
    fig_tbl.savefig(SAVE_PATH / "resultados_SiSiGe_tabla2.png", dpi=150, bbox_inches="tight")

    # Figura 2: Perfil U(x)
    fig_pot, ax_pot = plt.subplots(figsize=(9, 5.5))
    plot_potential(ax_pot, results)
    fig_pot.savefig(SAVE_PATH / "resultados_SiSiGe_perfil_potencial2.png", dpi=150, bbox_inches="tight")

    # Figura 3: Transmisión T(E)
    fig_tra, ax_tra = plt.subplots(figsize=(9, 5.5))
    plot_transmission(ax_tra, results)
    fig_tra.savefig(SAVE_PATH / "resultados_SiSiGe_transmision2.png", dpi=150, bbox_inches="tight")
